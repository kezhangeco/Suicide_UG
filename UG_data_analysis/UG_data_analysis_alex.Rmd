...
plot(eff.m$ReappraisalDirection , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(eff.m$`scale(totalStake)` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(eff.m$Fairness_score , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(eff.m$group4 , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
...
# interaction effect and main effect
eff.m <- allEffects(m_exit)
plot(eff.m$`scale(EXIT)` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
...
print(logit2prob(cf1))
# interaction effect and main effect
eff.m <- allEffects(m_education)
plot(eff.m$`scale(EDUCATION)` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
...
# interaction effect and main effect
eff.m <- allEffects(m_income)
plot(eff.m$`scale(IncomePerCapita)` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
...
# interaction effect and main effect
eff.m <- allEffects(m_mmse)
plot(eff.m$`scale(MMSE)` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
...
# interaction effect and main effect
eff.m <- allEffects(m_urgency)
plot(eff.m$`scale(urgency)` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
...
# interaction effect and main effect
eff.m <- allEffects(m_interpersonal)
plot(eff.m$`scale(IIP15INTAMBV)` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
...
# interaction effect and main effect
eff.m <- allEffects(m_nonplan)
plot(eff.m$`scale(BIS_NONPLAN)` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
...
### The no interaction model with all individual subject level variable
$$Accept\,Offer = Reappraisal\,Direction + scale(total\,Stake) + Fairness\,score + group4 + income + EXIT + BIS_NONPLAN + interpersonal + (1|ID)$$
```{r all subject level var1, echo=FALSE}
m3_all <- update(m3, .~. + scale(IncomePerCapita) + scale(EXIT) + scale(BIS_NONPLAN) + scale(IIP15INTAMBV))
stargazer(m3_all, type = "text")
cf <- data.frame(summary(m3_all)$coefficients[, 1])
colnames(cf) <- c("probability")
print("probability coefficients")
print(logit2prob(cf))

# main effect
eff.m <- allEffects(m3_all)
plot(eff.m$ReappraisalDirection , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = )
plot(eff.m$`scale(totalStake)` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(eff.m$Fairness_score , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(eff.m$`scale(IncomePerCapita)` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(eff.m$`scale(EXIT)` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
...
```{r 4way interaction1, include = FALSE}
...
```{r 3way interaction2, include = FALSE}
...
```{r 3way interaction3, echo=FALSE}
...
# interaction effect and main effect
eff.m <- allEffects(m2_3interaction2)
print(eff.m)
plot(eff.m$`ReappraisalDirection:scale(totalStake):group4` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)

plot(eff.m$Fairness_score , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(effect("group4", m2_3interaction2), axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(effect("ReappraisalDirection", m2_3interaction2), axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(effect("ReappraisalDirection * scale(totalStake)", m2_3interaction2), axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(effect("ReappraisalDirection * group4", m2_3interaction2), axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(effect("scale(totalStake) * group4", m2_3interaction2), axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
```
...
eff.m <- allEffects(m2_2interaction1)
plot(eff.m$`Fairness_score:group4` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE)
plot(effect("Fairness_score", m2_2interaction1) , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE)
plot(effect("group4", m2_2interaction1) , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE)
```
...
# main effect and interaction effect
eff.m <- allEffects(m2_2interaction2)
plot(eff.m$`ReappraisalDirection:group4`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1)), x = list(rotate = 90)), multiline = TRUE)
...
# main effect and interaction effect
eff.m <- allEffects(m2_2interaction4)
plot(eff.m$`scale(totalStake):group4`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(eff.m$ReappraisalDirection, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), rug = FALSE)
```
...
# main effect and interaction effect
eff.m <- allEffects(m2_2interaction5)
plot(eff.m$`scale(totalStake):Fairness_score`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(eff.m$group4, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), rug = FALSE)
plot(effect("scale(totalStake)", m2_2interaction5), axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), rug = FALSE)
...
```{r best interaction model1, echo=FALSE}
...
# the best interaction model is better than the no interaction model?
anova(m2_3interaction2, m3)
# yes
```
...
# main effect and interaction effect
eff.m <- allEffects(m_exit1)
plot(eff.m$`ReappraisalDirection:scale(totalStake):group4`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = "Reappraisal Direction * total Stake * group4 controlling EXIT in (1|ID)")
plot(eff.m$`scale(EXIT)`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), rug = FALSE)
```
...
### The best interaction model with all individual subject level variable
$$Accept\,Offer = Fairness\,score + Reappraisal\,Direction * scale(total\,Stake) * group4 + income + EXIT + BIS_NONPLAN + interpersonal + (1|ID)$$
```{r all subject level variable, echo=FALSE, include=FALSE}
m2_3interaction2_all <- update(m2_3interaction2, .~. + scale(IncomePerCapita) + scale(EXIT) + scale(BIS_NONPLAN) + scale(IIP15INTAMBV), glmerControl(calc.derivs = FALSE, optCtrl = list(maxfun = 2e4)))
```
Too iteration exceeds max to converge.
...
# main effect and interaction effect
eff.m <- allEffects(m_exit4)
plot(eff.m$`ReappraisalDirection:group4`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = "Reappraisal Direction * group4 controlling EXIT")
```
...
# main effect and interaction effect
eff.m <- allEffects(m5)
plot(eff.m$ReappraisalDirection, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = "Reappraisal Direction in (block|ID)")
plot(eff.m$`scale(totalStake)`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = "total stake in (block|ID)")
plot(eff.m$Fairness_score, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = "Fairness score in (block|ID)")
...
# main effect
eff.m <- allEffects(m7)
plot(eff.m$group4, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = "group effect in (block|ID)")
...
# main effect 
eff.m <- allEffects(m_exit2)
plot(eff.m$`scale(EXIT)`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = "EXIT in (block|ID)")
...
# main effect and interaction effect
eff.m <- allEffects(m_nonplan2)
plot(eff.m$`scale(BIS_NONPLAN)`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = "non-plan in (block|ID)")
...
### The no interaction model with all individual subject level variable
$$Accept\,Offer = Reappraisal\,Direction + scale(total\,Stake) + Fairness\,score + group4 + income + EXIT + BIS_NONPLAN + interpersonal + (block|ID)$$
```{r all subject level variable1, echo=FALSE}
m7_all <- update(m7, .~. + scale(IncomePerCapita) + scale(EXIT) + scale(BIS_NONPLAN) + scale(IIP15INTAMBV))
stargazer(m7_all, type = "text")
cf <- data.frame(summary(m7_all)$coefficients[, 1])
colnames(cf) <- c("probability")
print("probability coefficients")
print(logit2prob(cf))

# main effect
eff.m <- allEffects(m7_all)
plot(eff.m$ReappraisalDirection , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = )
plot(eff.m$`scale(totalStake)` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(eff.m$Fairness_score , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(eff.m$`scale(IncomePerCapita)` , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
...
```{r 4way interaction2, include=FALSE}
...
```{r 3way interaction1, include=FALSE}
...
# main effect and interaction effect
eff.m <- allEffects(m9_3interaction)
plot(eff.m$`ReappraisalDirection:scale(totalStake):group4`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = "Reappraisal Direction * totalStake * group4 in (block|ID)")

plot(eff.m$Fairness_score , axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(effect("group4", m9_3interaction), axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(effect("ReappraisalDirection", m9_3interaction), axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(effect("ReappraisalDirection * scale(totalStake)", m9_3interaction), axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
plot(effect("ReappraisalDirection * group4", m9_3interaction), axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)

plot(effect("scale(totalStake) * group4", m9_3interaction), axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE)
```
...
# main effect and interaction effect
eff.m <- allEffects(m9_2interaction1)
plot(eff.m$`Fairness_score:group4`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = "Fairness score * group4 in (block|ID)")
...
# main effect and interaction effect
eff.m <- allEffects(m9_2interaction2)
plot(eff.m$`ReappraisalDirection:group4`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = "Reappraisal Direction * group4 in (block|ID)")
```
...
# main effect and interaction effect
eff.m <- allEffects(m9_2interaction4)
plot(eff.m$`scale(totalStake):group4`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = "totalStake * group4 in (block|ID)")
...
# main effect and interaction effect
eff.m <- allEffects(m9_2interaction5)
plot(eff.m$`scale(totalStake):Fairness_score`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = "totalStake * fairness score in (block|ID)")
...
```{r best interaction model2, echo=FALSE}
...
# main effect and interaction effect
eff.m <- allEffects(m_exit3)
plot(eff.m$`ReappraisalDirection:scale(totalStake):group4`, axes = list(y=list(lab = "P(accept)", type = "response", lim = c(0,1))), multiline = TRUE, rug = FALSE, main = "Reappraisal Direction * totalStake * group4 controlling EXIT in (block|ID)")
