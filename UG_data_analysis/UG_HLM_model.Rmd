...
```{r}
# test if HLM is needed: whether there is variation over the context: subject type
...
randomInterceptOnly <- glmer(task$AcceptOffer ~ 1 + (1|group4), data = task, family = binomial)
