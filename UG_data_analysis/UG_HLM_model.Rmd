...
# the smallest AIC
d_m_level1_1 <- get.models(d_m_level1,1)[[1]]

# the second smallest AIC
d_m_level1_2 <- get.models(d_m_level1, subset = 0 < delta & delta < 0.07)
...
m_level1_slope1_all <- all_fit(m_level1_slope1)
...
# the smallest AIC
m_d_level1_slope1_1 <- get.models(m_d_level1_slope1,1)[[1]]

# the second smallest AIC
m_d_level1_slope1_2 <- get.models(m_d_level1_slope1, subset = 0 < delta & delta < 2)
```
...
m_level1_slope2_all <- all_fit(m_level1_slope2)
summary(m_level1_slope2)

```
The global model can't be converge at various optimizers. May abandon this model?
...
# the smallest AIC
m_d_level1_slope2_1 <- get.models(m_d_level1_slope2,1)[[1]]

# the second smallest AIC
m_d_level1_slope2_2 <- get.models(m_d_level1_slope2, subset = 0 < delta & delta < 2)
...
```
The models can't be converged by all optimizers.
