...
```{r}
m1 <- glmulti(allData$AcceptOffer ~ ReappraisalDirection * scale(totalStake) * Fairness_score, level = 2, fitfunction = glmer.glmulti, random = "+ (1|ID)", method = "d", data = allData)
...
m_education <- glmer(allData$AcceptOffer ~ )
```
