...
myVar <- c("EDUCATION", "GENDERTEXT", "PER.CAPITA.INCOME", "PROTECT2AGE", 
           ...
           "BIS_NONPLAN", "Nurgency", "Purgency", "IIP15INTAMBV", "IIP15INTSEN", 
...
m1gl1 <-
  ...
  nAGQ = 0,
  control = glmerControl(optimizer = "bobyqa"))
stargazer(m1gl1, type = "text", title = "AcceptOffer ~ eappraisalDirection * scale(fairLR) * scale(totalStake) + ReappraisalDirection *
