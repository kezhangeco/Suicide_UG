...
demoQuestion <- plyr::rename(demoQuestion, c("UPPSP.NEG.URGENCY" = "Nurgency", "UPPSP.POS.URGENCY" = "Purgency", "MMSE.TOTAL" = "MMSETOTAL"))

# compare the group differences
myVar <- c("EDUCATION", "GENDERTEXT", "PROTECT2AGE", "RACETEXT", "MMSETOTAL", 
           "WTARSS", "WTARRAW", "DRS", "EXIT", "BIS_NONPLAN", "Nurgency", "Purgency",
           "IIP15INTAMBV", "SSI.BL.CURRENT", "IIP15INTSEN", "IIP15AGRESS")
...
export2csv(t2_1, file = "/Volumes/LAB/Suicide_UG/UG_data_analysis/outputs/demo1.csv")
